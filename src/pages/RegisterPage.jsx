  ...
  return (
    <>
      <main className='flex flex-row w-full'>
        ...
        <form onSubmit={handleCadastro} className='px-40 bg-[#F9F9FF] w-full flex justify-center items-baseline flex-col'>
          ...
          <div className='mt-8'>
            ...
            <div className='flex flex-row h-12.25 w-md bg-white border border-[#CCC3D8] rounded-xl'>
              ...
              <input type="name" placeholder='Ex.: Ana Silva' className='w-full rounded-xl focus:border-0 focus:outline-0' value={nome} onChange={(e) => setNome(e.target.value)} />
            </div>
          </div>
          <div className='my-6'>
            ...
            <div className='flex flex-row h-12.25 w-md bg-white border border-[#CCC3D8] rounded-xl'>
              ...
              <input type="email" placeholder='nome@exemplo.edu' className='w-full rounded-xl focus:border-0 focus:outline-0' value={email}
                onChange={
                  (e) => {
          ...
          <div className='flex flex-row'>
            <div className='mr-4'>
              ...
              <div className='flex flex-row bg-white border border-[#CCC3D8] rounded-xl h-12.25 w-54'>
                ...
                <input type="password" placeholder='••••••••' className='w-full rounded-xl focus:border-0 focus:outline-0' value={senha}
            ...
            <div>
              ...
              <div className='flex flex-row bg-white border border-[#CCC3D8] rounded-xl h-12.25 w-54'>
                ...
                <input type="password" placeholder='••••••••' className='w-full rounded-xl focus:border-0 focus:outline-0' value={confirmSenha}
                  onChange={(e) => {
                    setConfirmSenha(e.target.value)
                  }} 
                  onKeyUp={() => verificarSenha()} />
              </div>
                {mensagem && <span className="text-red-400 w-full text-sm">{mensagem}</span>}
            </div>
          </div>
          <button 
          disabled={mensagem}
          className={`${ mensagem ? "bg-gray-300": "bg-primary"} text-white mt-6 w-md h-15 text-[20px] font-semibold rounded-xl shadow-xl `}type="submit">Criar conta</button>
